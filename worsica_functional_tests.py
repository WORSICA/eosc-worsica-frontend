...
def t02_create_coastal_processing(driver):
    ...
    #try:
    WebDriverWait(driver, timeout=7).until(lambda d: len(d.find_elements(By.CSS_SELECTOR, "#selectROI option"))>0)
    ...
    ##WebDriverWait(driver, timeout=5).until(lambda d: d.find_element(By.ID, "tableOfDetections"))
    #=================Step1 (Region Of Interest)=================
    worsica_logger.info("[t02_create_coastal_processing]: Step1 (Region Of Interest) Fill in name and draw on the map the ROI")
    ...
    #=================Step2 (Inputs)=================
    worsica_logger.info("[t02_create_coastal_processing]: Step2 (Inputs) List L1C, L2a with 10% CC. Click Level1C. ")
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "optSentinel2-L1C").click()
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "bnext").click()
    #=================Step3 (Inputs Revision)=================
    worsica_logger.info("[t02_create_coastal_processing]: Step3 (Inputs Revision) Select first two images ")
    WebDriverWait(driver, timeout=7).until(lambda d: len(d.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr"))>0)
    ...
    driver.find_element(By.ID, "bnext").click()
    #=================Step5 (Opencoasts)=================
    #worsica_logger.info("[t02_create_coastal_processing]: Step5 (Opencoasts) Just disable the connection ")
    #time.sleep(WAIT_TIME_SEC)
    #driver.find_element(By.ID, "step5OCConnection-enable").click()
    #time.sleep(WAIT_TIME_SEC)
    #driver.find_element(By.ID, "bnext").click()
    #=================Step6 (Run)=================
    worsica_logger.info("[t02_create_coastal_processing]: Step6 (Run) Set name but then do not submit, just close the wizard.")
    driver.find_element(By.ID, 'simulationName').send_keys('Test1')
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, 'leftPanel').find_element(By.CLASS_NAME, "close").click() #close the left panel
    time.sleep(WAIT_TIME_SEC)
    ...
    time.sleep(WAIT_TIME_SEC)
    tr_roi = driver.find_element(By.ID,"showVisualizationAndDetectionManager").find_elements(By.CSS_SELECTOR, "#listOfROI tr")
    tr_roi[0].find_element(By.ID, 'clickDelete').click()
    time.sleep(WAIT_TIME_SEC)
    driver.find_elements(By.CSS_SELECTOR, ".ui-dialog-buttonset button")[0].click()#Yes, to cleanup everything :)
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, 'rightPanel').find_element(By.CLASS_NAME, "close").click() #close the left panel
    time.sleep(WAIT_TIME_SEC)
    #Logout
    _do_logout(driver)
    worsica_logger.info("[t02_create_coastal_processing]: OK!")
    #except Exception as e:
    #    print("[t02_create_coastal_processing]: Error! "+str(e))
    #    driver.quit()
    #    exit(1)
...
def t03_create_inland_processing(driver):
    ...
    ##WebDriverWait(driver, timeout=5).until(lambda d: d.find_element(By.ID, "tableOfDetections"))
    #=================Step1 (Region Of Interest)=================
    worsica_logger.info("[t03_create_inland_processing]: Step1 (Region Of Interest) Fill in name and draw on the map the ROI")
    driver.find_element(By.ID, "roiName").send_keys('Selenium Test')
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "iconDrawPolygon").click()
    time.sleep(WAIT_TIME_SEC)
    ...
    driver.find_element(By.ID, "bnext").click()
    #=================Step2 (Inputs)=================
    worsica_logger.info("[t03_create_inland_processing]: Step2 (Inputs) List L1C, L2a with 10% CC. Click Level1C. ")
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "optSentinel2-L1C").click()
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "bnext").click()
    #=================Step3 (Inputs Revision)=================
    worsica_logger.info("[t03_create_inland_processing]: Step3 (Inputs Revision) Select first two images ")
    WebDriverWait(driver, timeout=7).until(lambda d: len(d.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr"))>0)
    #driver.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr"):
    tr_imagesets = driver.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr")
    tr_imagesets[0].find_element(By.CLASS_NAME, 'custom-checkbox').click()
    ...
    driver.find_element(By.ID, "bnext").click()
    #=================Step5 (Run)=================
    worsica_logger.info("[t03_create_inland_processing]: Step6 (Run) Set name but then do not submit, just close the wizard.")
    driver.find_element(By.ID, 'simulationName').send_keys('Test1')
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, 'leftPanel').find_element(By.CLASS_NAME, "close").click() #close the left panel
    time.sleep(WAIT_TIME_SEC)
    ...
    #except Exception as e:
    #    worsica_logger.info("[t03_create_inland_processing]: Error! "+str(e))
    #    driver.quit()
    #    exit(1)
...
def t04_create_waterleak_processing(driver):
    ...
    ##WebDriverWait(driver, timeout=5).until(lambda d: d.find_element(By.ID, "tableOfDetections"))
    #=================Step1 (Region Of Interest)=================
    worsica_logger.info("[t04_create_waterleak_processing]: Step1 (Region Of Interest) Fill in name and draw on the map the ROI")
    driver.find_element(By.ID, "roiName").send_keys('Selenium Test')
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "iconDrawPolygon").click()
    time.sleep(WAIT_TIME_SEC)
    ...
    driver.find_element(By.ID, "bnext").click()
    #=================Step2 (Inputs)=================
    worsica_logger.info("[t04_create_waterleak_processing]: Step2 (Inputs) List L1C, L2a with 10% CC. Click Level1C. ")
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "optSentinel2-L1C").click()
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, "bnext").click()
    #=================Step3 (Inputs Revision)=================
    worsica_logger.info("[t04_create_waterleak_processing]: Step3 (Inputs Revision) Select first two images ")
    WebDriverWait(driver, timeout=7).until(lambda d: len(d.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr"))>0)
    #driver.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr"):
    tr_imagesets = driver.find_elements(By.CSS_SELECTOR, "#listOfImagesets tr")
    tr_imagesets[0].find_element(By.CLASS_NAME, 'custom-checkbox').click()
    ...
    driver.find_element(By.ID, "bnext").click()
    #=================Step5 (Run)=================
    worsica_logger.info("[t04_create_waterleak_processing]: Step6 (Run) Set name but then do not submit, just close the wizard.")
    driver.find_element(By.ID, 'simulationName').send_keys('Test1')
    time.sleep(WAIT_TIME_SEC)
    driver.find_element(By.ID, 'leftPanel').find_element(By.CLASS_NAME, "close").click() #close the left panel
    time.sleep(WAIT_TIME_SEC)
    ...
    #except Exception as e:
    #    worsica_logger.info("[t04_create_waterleak_processing]: Error! "+str(e))
    #    driver.quit()
    #    exit(1)
