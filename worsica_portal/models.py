...
from .models_base import Name, BlobTextTrait
from django.contrib.auth.models import User, Group
from django_countries.fields import CountryField
from django.db.models import (
    Model, ForeignKey, OneToOneField, ManyToManyField, BooleanField, CharField,
    IntegerField, FloatField, CASCADE
)
...
class AreaOfStudy(Name, BlobTextTrait):
    ...
    service = CharField(editable=True, choices=Service._CHOICES,
                        default=Service.COASTAL, max_length=40)
